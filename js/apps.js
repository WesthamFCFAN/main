...
const sttaddr = "0x8d7a4a88084a0cefc6f1f2278e51c15b259b6d3c";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x8d7a4a88084a0cefc6f1f2278e51c15b259b6d3c";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://westhamfc.net?ref=' + document.getElementById('refaddress').value;
        }
    }
}
